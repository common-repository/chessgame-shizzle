...
function chessgame_shizzle_display_meta_box() {
	...
	$cs_chessgame_fen = chessgame_shizzle_save_fen_to_meta( $post_id, $cs_chessgame_pgn );
	echo '
		<div class="cs_chessgame_custom_field">
			<label class="cs_chessgame_fen" for="cs_chessgame_fen">
				<span class="cs_chessgame_title">' . esc_html__('FEN code (read-only)', 'chessgame-shizzle' ) . '</span>
					"' . $cs_chessgame_fen . '"
			</label>
		</div>';
